...
$query = "SELECT threads.thread_title,comments.comment_id,comments.comment_content,comments.comment_by,comments.comment_time FROM threads INNER JOIN comments WHERE threads.thread_id=comments.comment_id; ;";
